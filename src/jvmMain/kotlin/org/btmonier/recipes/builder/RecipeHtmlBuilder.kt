...
class RecipeHtmlBuilder {
    ...
    private fun buildIngredients(ingredients: List<String>): String {
        ...
        ingredients.forEach { ingredient ->
            html.append("        <li class=\"recipe-ingredient-item\">${escapeHtml(ingredient)}</li>\n")
        }
    ...
    private fun buildInstructions(instructions: List<String>): String {
        ...
        instructions.forEach { instruction ->
            html.append("        <li class=\"recipe-instruction-item\">${escapeHtml(instruction)}</li>\n")
        }
    ...
    private fun buildNotes(notes: List<String>): String {
        ...
        notes.forEach { note ->
            html.append("        <li class=\"recipe-note-item\">${escapeHtml(note)}</li>\n")
        }
